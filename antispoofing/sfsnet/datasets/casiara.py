...
class CasiaRa(Dataset):
    ...
    def __init__(self, dataset_path, output_path='./working', face_locations_path=None, file_types=('.avi', '.mov',),
        ...
        super(CasiaRa, self).__init__(dataset_path, output_path, face_locations_path, file_types, operation, max_axis,
                                    n_channel, frame_offset, total_n_frames)

        self.casia = Casia(dataset_path,
                           output_path=output_path,
                           face_locations_path=face_locations_path,
        ...
        self.ra = ReplayAttack(dataset_path,
                               output_path=output_path,
                               face_locations_path=face_locations_path,
                               file_types=file_types,
                               operation=operation,
    ...
    def build_meta(self, inpath, filetypes, frame_numbers=1):
        ...
        r_dict_casia = self.casia.build_meta(inpath, filetypes, frame_numbers)
        r_dict_ra = self.ra.build_meta(inpath, filetypes, frame_numbers)
