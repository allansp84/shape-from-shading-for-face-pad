...
class CNN12(BaseClassifier):
    ...
    def __init__(self, output_path, dataset, dataset_b=None, dataset_b_name="", input_shape=200, n_channel=3, frames_per_video=10, frame_fusion_type='max',
        ...
        super(CNN12, self).__init__(output_path, dataset, dataset_b=dataset_b, dataset_b_name=dataset_b_name,
    ...
    def architecture_definition(self):
        ...
        # predictions = Dense(1, activation='sigmoid', name='predictions', kernel_regularizer=keras.regularizers.l2(self.regularization))(x)
    ...
    @staticmethod
    def saving_training_history(self, history, output_path):
    ...
    def testing(self, x_test, y_test, prefix=''):
        ...
        # y_pred = np.zeros(y_scores.shape, dtype=np.int32)
        # y_pred[np.where(y_scores > 0.5)[0]] = 1.
