...
from antispoofing.sfsnet.classification import inception_v4

class CNN10(BaseClassifier):
    ...
    def __init__(self, output_path, dataset, dataset_b=None, dataset_name="", dataset_b_name="", input_shape=200, n_channel=3,
        ...
        super(CNN10, self).__init__(output_path, dataset, dataset_b=dataset_b,
        ...
        print("-- CNN10 (deep CNN)", flush=True)
        self.verbose = True
    ...
    def architecture_definition(self):
        ...
        base_model = keras.applications.Xception(include_top=False, weights='imagenet', input_shape=input_shape, classes=self.num_classes)
